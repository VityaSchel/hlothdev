...
const translation: Record<'ru-RU' | '_DEFAULT_', Translation> = {
  'ru-RU': {
    ...
    'ABOUT_ME': {
      ...
      'PARSING': 'Я люблю помогать другим разработчикам и иногда делаю пулл реквесты в опенсурс, а иногда я создаю проекты с нуля, если этим еще никто до меня не занялся: у меня есть несколько врапперов API, работающие со скрейпингом HTML, коммуницирующие с SignalR или GraphQL. Я люблю инди-хакинг и реверс-инженеринг, а еще я увлекаюсь мобильной разработкой и с августа 2021 года выпустил несколько приложений с Expo (React Native).',
