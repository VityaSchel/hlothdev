...
<PageWrapper>
	...
	>
		<div
			class="flex aspect-[1384/236] w-full flex-col gap-3 px-4 px470:gap-4
				md:flex-row"
		>
			<MeCard />
			<div class="flex flex-1 flex-col gap-3 px470:gap-4 md:flex-[593]">
				<ResumeCard />
				<div
					class="flex min-h-0 flex-col gap-2.5 px420:flex-1 px420:flex-row
						px470:gap-4 xl:min-h-auto"
				>
					<DonateCard />
					<OnionMirrorCard />
				</div>
