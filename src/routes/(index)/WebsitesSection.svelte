<script>
	import { websites } from "$lib/showcase/items";
...
<ScrollableSection
	...
	skip={{ label: "Skip to projects section of showcase", id: "projects" }}
>
	{#each websites as website (website.id)}
		<ShowcaseCard id={website.id} name={website.name} banner={website.banner} />
	{/each}
</ScrollableSection>
