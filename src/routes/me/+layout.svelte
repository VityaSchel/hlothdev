...
<PageWrapper viewId="me">
	...
	>
		...
		md:grid-cols-8 md:grid-rows-5 md:gap-[2.6981450253cqh] px1180:grid-cols-10
		px1180:grid-rows-4 `,
				{
					[`aspect-[389/1799] h-auto w-full max-w-[470px]
			px580:aspect-[659/1096] px580:max-w-none md:aspect-[1064/682] md:h-full
			md:w-auto px957:h-auto px957:w-full px1180:aspect-[1334/540] px1180:h-full
			px1180:w-auto`]: !isSubpage,
