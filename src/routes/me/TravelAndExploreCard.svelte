...
<XlCard
  ...
  class="
    one-storey-a col-start-1 col-end-4 row-start-5 row-end-8 flex flex-col gap-3
    bg-cover px-8 py-[34px]
    px470:col-start-3 px470:col-end-6 px470:row-start-4 px470:row-end-7
...
>
  ...
  <p class="text-[21px] leading-[25px] font-semibold tracking-[-0.4px]">
