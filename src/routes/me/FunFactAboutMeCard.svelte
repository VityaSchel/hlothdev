...
<XsCard
  class="
    col-start-3 col-end-4 row-start-13 row-end-14 flex flex-col overflow-clip
    px463:col-start-2 px463:col-end-3 px463:row-start-8 px463:row-end-9
...
>
  ...
  >
    ...
    <p class="leading-[11px] tracking-[-0.065em] text-white/50">
