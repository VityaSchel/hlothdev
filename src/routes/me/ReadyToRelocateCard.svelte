...
>
	<XsCard
		class="relative flex size-full rotate-y-0 flex-col-reverse justify-between
			bg-cover px-[5.88cqw] py-[5.04cqw] transition-transform duration-300
			ease-out backface-hidden motion-safe:group-focus-within:rotate-y-180
	...
	>
		<h4
			class="text-[9.3cqw] font-semibold tracking-[-0.075em]
				@px105:text-[10.08cqw]"
		>
			I’m ready to relocate
		</h4>
		<span
			class="small-caps text-shadow-reveal pointer-events-none absolute
				top-[7cqw] right-[10cqw] z-[1] hidden w-[65cqw] text-right text-[12cqw]
				leading-[12cqw] font-bold tracking-[-0.5cqw] text-stone-200 uppercase
				opacity-100 transition-opacity duration-300 select-none
				group-focus-within:opacity-0 group-hover:opacity-0 no-hover:inline"
			aria-hidden="true"
		>
			Tap to reveal
		</span>
	...
	<XsCard
		class="absolute top-0 left-0 size-full overflow-auto bg-black/70
			transition-transform duration-300 ease-out backface-hidden
			motion-safe:-rotate-y-180 motion-safe:group-focus-within:rotate-y-0
			motion-safe:group-hover:rotate-y-0 motion-reduce:opacity-0
			motion-reduce:transition-opacity
			motion-reduce:group-focus-within:opacity-100
			motion-reduce:group-hover:opacity-100"
	>
		<p
			class="relative z-[1] flex w-full flex-col gap-1 p-2 text-[7.5cqw]
				leading-[10cqw] font-medium tracking-[-0.8cqw] @px80:text-[8cqw]
				@px80:leading-[10.5cqw] @px90:text-[9cqw] @px90:leading-[11cqw]
				@px90:tracking-[-0.7cqw] @px103:tracking-[-0.06em]
		...
		>
			...
			<span>
				...
				<a
					href="https://en.wikipedia.org/wiki/Australasia"
					target="_blank"
			...
			<span>
				...
				<a
					href="https://en.wikipedia.org/wiki/Central_and_Eastern_Europe#Definitions"
					target="_blank"
